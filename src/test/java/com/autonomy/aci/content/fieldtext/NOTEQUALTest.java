...
public class NOTEQUALTest {
    ...
    public void testStaticStringFieldName() {
        assertEquals("NOTEQUAL{1}:field", NOTEQUAL("field", 1).toString());
        assertEquals("NOTEQUAL{1.2}:field", NOTEQUAL("field", 1.2).toString());
        assertEquals("NOTEQUAL{1}:field", NOTEQUAL("field", 1L).toString());
        assertEquals("NOTEQUAL{1.3}:field", NOTEQUAL("field", 1.3f).toString());
        assertEquals("NOTEQUAL{1}:field", NOTEQUAL("field", (byte)1).toString());
        assertEquals("NOTEQUAL{1}:field", NOTEQUAL("field", (short)1).toString());
        assertEquals("NOTEQUAL{1.3}:field", NOTEQUAL("field", new BigDecimal("1.3")).toString());

        assertEquals("NOTEQUAL{1,2}:field", NOTEQUAL("field", 1, 2).toString());
        assertEquals("NOTEQUAL{1.3,2}:field", NOTEQUAL("field", 1.3, 2).toString());
        assertEquals("NOTEQUAL{1,2.3}:field", NOTEQUAL("field", 1, 2.3).toString());
        assertEquals("NOTEQUAL{1,2.3}:field", NOTEQUAL("field", 1L, 2.3).toString());
        assertEquals("NOTEQUAL{1,2.3}:field", NOTEQUAL("field", 1L, new BigDecimal("2.3")).toString());

        assertEquals("NOTEQUAL{1,2}:field", NOTEQUAL("field", new int[]{1, 2}).toString());
        assertEquals("NOTEQUAL{1.3,2.4}:field", NOTEQUAL("field", new double[]{1.3, 2.4}).toString());
        assertEquals("NOTEQUAL{1,2}:field", NOTEQUAL("field", new long[]{1L, 2L}).toString());

        assertEquals("NOTEQUAL{1,2}:field", NOTEQUAL("field", new Integer[]{1, 2}).toString());

        assertEquals("NOTEQUAL{1,2.3}:field", NOTEQUAL("field", Arrays.asList(1L, 2.3)).toString());
    }
    ...
    public void testStaticArrayFieldNames() {
        ...
        assertEquals("NOTEQUAL{1}:field:title", NOTEQUAL(fields, 1).toString());
        assertEquals("NOTEQUAL{1.2}:field:title", NOTEQUAL(fields, 1.2).toString());
        assertEquals("NOTEQUAL{1}:field:title", NOTEQUAL(fields, 1L).toString());
        assertEquals("NOTEQUAL{1.3}:field:title", NOTEQUAL(fields, 1.3f).toString());
        assertEquals("NOTEQUAL{1}:field:title", NOTEQUAL(fields, (byte)1).toString());
        assertEquals("NOTEQUAL{1}:field:title", NOTEQUAL(fields, (short)1).toString());
        assertEquals("NOTEQUAL{1.3}:field:title", NOTEQUAL(fields, new BigDecimal("1.3")).toString());

        assertEquals("NOTEQUAL{1,2}:field:title", NOTEQUAL(fields, 1, 2).toString());
        assertEquals("NOTEQUAL{1.3,2}:field:title", NOTEQUAL(fields, 1.3, 2).toString());
        assertEquals("NOTEQUAL{1,2.3}:field:title", NOTEQUAL(fields, 1, 2.3).toString());
        assertEquals("NOTEQUAL{1,2.3}:field:title", NOTEQUAL(fields, 1L, 2.3).toString());
        assertEquals("NOTEQUAL{1,2.3}:field:title", NOTEQUAL(fields, 1L, new BigDecimal("2.3")).toString());

        assertEquals("NOTEQUAL{1,2}:field:title", NOTEQUAL(fields, new int[]{1, 2}).toString());
        assertEquals("NOTEQUAL{1.3,2.4}:field:title", NOTEQUAL(fields, new double[]{1.3, 2.4}).toString());
        assertEquals("NOTEQUAL{1,2}:field:title", NOTEQUAL(fields, new long[]{1L, 2L}).toString());

        assertEquals("NOTEQUAL{1,2}:field:title", NOTEQUAL(fields, new Integer[]{1, 2}).toString());

        assertEquals("NOTEQUAL{1,2.3}:field:title", NOTEQUAL(fields, Arrays.asList(1L, 2.3)).toString());
    }
