...
import static com.autonomy.aci.content.fieldtext.EQUALALL.*;
...
public class EQUALALLTest {
    ...
    public void testStaticStringFieldName() {
        assertEquals("EQUALALL{1}:field", EQUALALL("field", 1).toString());
        assertEquals("EQUALALL{1.2}:field", EQUALALL("field", 1.2).toString());
        assertEquals("EQUALALL{1}:field", EQUALALL("field", 1L).toString());
        assertEquals("EQUALALL{1.3}:field", EQUALALL("field", 1.3f).toString());
        assertEquals("EQUALALL{1}:field", EQUALALL("field", (byte)1).toString());
        assertEquals("EQUALALL{1}:field", EQUALALL("field", (short)1).toString());
        assertEquals("EQUALALL{1.3}:field", EQUALALL("field", new BigDecimal("1.3")).toString());

        assertEquals("EQUALALL{1,2}:field", EQUALALL("field", 1, 2).toString());
        assertEquals("EQUALALL{1.3,2}:field", EQUALALL("field", 1.3, 2).toString());
        assertEquals("EQUALALL{1,2.3}:field", EQUALALL("field", 1, 2.3).toString());
        assertEquals("EQUALALL{1,2.3}:field", EQUALALL("field", 1L, 2.3).toString());
        assertEquals("EQUALALL{1,2.3}:field", EQUALALL("field", 1L, new BigDecimal("2.3")).toString());

        assertEquals("EQUALALL{1,2}:field", EQUALALL("field", new int[]{1, 2}).toString());
        assertEquals("EQUALALL{1.3,2.4}:field", EQUALALL("field", new double[]{1.3, 2.4}).toString());
        assertEquals("EQUALALL{1,2}:field", EQUALALL("field", new long[]{1L, 2L}).toString());

        assertEquals("EQUALALL{1,2}:field", EQUALALL("field", new Integer[]{1, 2}).toString());

        assertEquals("EQUALALL{1,2.3}:field", EQUALALL("field", Arrays.asList(1L, 2.3)).toString());
    }
    ...
    public void testStaticArrayFieldNames() {
        ...
        assertEquals("EQUALALL{1}:field:title", EQUALALL(fields, 1).toString());
        assertEquals("EQUALALL{1.2}:field:title", EQUALALL(fields, 1.2).toString());
        assertEquals("EQUALALL{1}:field:title", EQUALALL(fields, 1L).toString());
        assertEquals("EQUALALL{1.3}:field:title", EQUALALL(fields, 1.3f).toString());
        assertEquals("EQUALALL{1}:field:title", EQUALALL(fields, (byte)1).toString());
        assertEquals("EQUALALL{1}:field:title", EQUALALL(fields, (short)1).toString());
        assertEquals("EQUALALL{1.3}:field:title", EQUALALL(fields, new BigDecimal("1.3")).toString());

        assertEquals("EQUALALL{1,2}:field:title", EQUALALL(fields, 1, 2).toString());
        assertEquals("EQUALALL{1.3,2}:field:title", EQUALALL(fields, 1.3, 2).toString());
        assertEquals("EQUALALL{1,2.3}:field:title", EQUALALL(fields, 1, 2.3).toString());
        assertEquals("EQUALALL{1,2.3}:field:title", EQUALALL(fields, 1L, 2.3).toString());
        assertEquals("EQUALALL{1,2.3}:field:title", EQUALALL(fields, 1L, new BigDecimal("2.3")).toString());

        assertEquals("EQUALALL{1,2}:field:title", EQUALALL(fields, new int[]{1, 2}).toString());
        assertEquals("EQUALALL{1.3,2.4}:field:title", EQUALALL(fields, new double[]{1.3, 2.4}).toString());
        assertEquals("EQUALALL{1,2}:field:title", EQUALALL(fields, new long[]{1L, 2L}).toString());

        assertEquals("EQUALALL{1,2}:field:title", EQUALALL(fields, new Integer[]{1, 2}).toString());

        assertEquals("EQUALALL{1,2.3}:field:title", EQUALALL(fields, Arrays.asList(1L, 2.3)).toString());
    }
