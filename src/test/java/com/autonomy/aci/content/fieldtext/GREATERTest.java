...
public class GREATERTest {
    ...
    public void testFactoryMethods() {
        assertEquals("GREATER{6}:field", GREATER("field", 6).toString());
        assertEquals("GREATER{6}:field:title", GREATER(new String[]{"field", "title"}, 6).toString());
        assertEquals("GREATER{6}:field:title", GREATER(Arrays.asList("field", "title"), 6).toString());
    }
