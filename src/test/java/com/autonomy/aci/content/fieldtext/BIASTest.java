...
import static com.autonomy.aci.content.fieldtext.BIAS.*;
...
public class BIASTest {
    ...
    public void testFactoryMethods() {
        assertEquals("BIAS{1,2,3}:field", BIAS("field", 1, 2, 3).toString());
        assertEquals("BIAS{1,2,3}:field:title", BIAS(new String[]{"field", "title"}, 1, 2, 3).toString());
        assertEquals("BIAS{1,2,3}:field:title", BIAS(Arrays.asList("field", "title"), 1, 2, 3).toString());
    }
}
