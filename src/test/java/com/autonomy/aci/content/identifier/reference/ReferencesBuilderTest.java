...
public class ReferencesBuilderTest {
    ...
    public void testStringIntConstructor() {
        ...
        assertEquals("ref", builder.toIndexingString());
    ...
    public void testStringVarargsConstructor() {
        ...
        assertEquals("ref1+ref2+ref3", builder.toIndexingString());
        assertFalse(builder.isEmpty());
    ...
    public void testAppend() {
        ...
        assertEquals("ref1+ref2+ref3+ref4+ref5", builder.toIndexingString());
        assertFalse(builder.isEmpty());
